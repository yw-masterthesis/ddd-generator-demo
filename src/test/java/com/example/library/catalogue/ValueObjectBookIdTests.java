...
class ValueObjectBookIdTests {
        ...
        private static final String AGGREGATE_NAME = "BookInstance";
        private static final String VALUE_OBJECT_NAME = "BookId";
        ...
        @Test
        void moduleShouldContainClassWithValueObejctsName() {
        ...
        void valueObjectShouldResideInDomainLayer() {
                ...
                JavaClass entityClass = importedClasses.stream()
                                .filter(javaClass -> javaClass.getSimpleName().equals(VALUE_OBJECT_NAME)).findFirst()
                                .get();
